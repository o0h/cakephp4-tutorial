...
return [
     ...
     * - encoding - The encoding used for HTML + mysql connections.
     ...
     *   `Debugger` should replace in dumped var and logs generated by `Debugger`.
     */
    'Debugger' => [
        'editor' => 'phpstorm',
    ],
     ...
     * - Do not use periods in mysql name - it may lead to error.
    ...
    'Datasources' => [
        ...
        'default' => [
             ...
             * fetched from the mysql. It can also be set directly with the
             * mysql configuration directive 'innodb_stats_on_metadata = 0'
             * which is the recommended value in production environments
             */
            //'docker-entrypoint-initdb.d' => ['SET GLOBAL innodb_stats_on_metadata = 0'],
        ],
     ...
     *    There are four built-in options: php, cake, cache, mysql.
     ...
     * - 'mysql' - Uses CakePHP's mysql sessions.
     ...
     *
     * To use mysql sessions, load the SQL file located at config/schema/sessions.sql
     */
    'Session' => [
        'defaults' => 'php',
    ],
